...
powerconsumption <- powerconsumption %>% 
  ...
  select(-c(GeneralDiffuseFlows,PowerConsumption_Zone1,PowerConsumption_Zone2,PowerConsumption_Zone3)) 
...
ggplot(data=avg_daily, aes(x=date, y=avg_daily_consumption, group=1)) +
  ...
  labs(title = "Avg Daily Power Consumption", x = "Date", y = "Power Consumption") +
...
```{r}
hourly_ts <- ts(hourly_powerconsumption$total_consumption_hr)

hourly_sarima = sarima(ts(hourly_powerconsumption$total_consumption_hr), p=2, d=1, q=0, P=0, D=1, Q=1, S=24,
                       xreg=cbind(
